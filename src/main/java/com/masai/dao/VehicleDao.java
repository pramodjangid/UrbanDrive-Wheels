...
public interface VehicleDao {
    ...
    Vehicle findById(int id) throws CarNotFoundException, DataAccessException;
    ...
    List<Vehicle> findByBrandAndModel(String brand, String model) throws DataAccessException;
